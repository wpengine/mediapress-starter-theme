...
/**
 * Title: Recommendations | 3 Cols | Side by Side
 * Slug: mediapress-starter-theme/recommendations-3-cols-side-by-side
 */
?>

<!-- wp:group {"layout":{"type":"default"}} -->
<div class="wp-block-group"><!-- wp:query {"queryId":45,"query":{"postType":"post","offset":0,"exclude":[],"inherit":false,"perPage":3,"sticky":"exclude"},"namespace":"wpengine-smart-search/recommendations","layout":{"type":"default"},"postLimit":3,"recommendationsType":"related"} -->
    <div class="wp-block-query"><!-- wp:heading {"textAlign":"left","level":3,"style":{"typography":{"fontSize":"26px"}}} -->
        ...
        <div class="wp-block-columns"><!-- wp:column {"width":""} -->
            ...
            <div class="wp-block-column"><!-- wp:post-terms {"term":"category","textAlign":"left","style":{"elements":{"link":{"color":{"text":"var:preset|color|accent"}}},"spacing":{"padding":{"top":"0em","bottom":"0em","left":"0em","right":"0em"}},"typography":{"fontSize":"0.8rem","textTransform":"uppercase"},"layout":{"selfStretch":"fit","flexSize":null}},"textColor":"accent"} /-->
